...
import com.kashapovrush.network_api.usecase.SearchUseCase
...
interface SearchStore : Store<SearchStore.Intent, SearchStore.State, SearchStore.Label> {
    ...
    sealed interface Intent {
        ...
        data class ClickCity(val city: com.kashapovrush.utils.entity.City) : Intent
    ...
    data class State(
        ...
        sealed interface SearchState {
            ...
            data class SuccessLoaded(val cities: List<City>) :
                SearchState
        }
    ...
    sealed interface Label {
        ...
        data class OpenForecast(val city: com.kashapovrush.utils.entity.City) : Label
...
class SearchStoreFactory @Inject constructor(
    ...
    private val changeFavouriteStateUseCase: com.kashapovrush.database_api.usecase.ChangeFavouriteStateUseCase
) {
    ...
    sealed interface Msg {
        ...
        data class SearchResultLoaded(val cities: List<City>) :
            Msg
