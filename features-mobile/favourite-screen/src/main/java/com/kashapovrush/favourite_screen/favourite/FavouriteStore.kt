...
import com.kashapovrush.network_api.usecase.GetWeatherUseCase
...
interface FavouriteStore :
    ...
    sealed interface Intent {
        ...
        data class ClickCityItem(val city: com.kashapovrush.utils.entity.City) : Intent
    }

    data class State(val cityItems: List<CityItem>) {

        data class CityItem(val city: com.kashapovrush.utils.entity.City, val weatherState: WeatherState)
    ...
    sealed interface Label {
        ...
        data class ClickCityItem(val city: com.kashapovrush.utils.entity.City) : Label
    }
}
...
class FavouriteStoreFactory @Inject constructor(
    ...
    private val favouriteCitiesUseCase: com.kashapovrush.database_api.usecase.FavouriteCitiesUseCase
) {
    ...
    sealed interface Action {
        ...
        data class FavouriteCitiesLoaded(val cities: List<com.kashapovrush.utils.entity.City>) :
            Action
    }
    ...
    private inner class ExecutorImpl :
        ...
        private suspend fun loadWeatherForCity(city: com.kashapovrush.utils.entity.City) {
