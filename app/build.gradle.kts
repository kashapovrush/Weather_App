...
android {
    namespace = "com.kashapovrush.weatherapptest"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.kashapovrush.weatherapptest"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        ...
        val apiKey = property("apiKey")?.toString() ?: error("add apiKey to properties")
